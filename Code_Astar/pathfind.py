...
class pathfind():
    ...
    def astar(self):
        ...
        while frontier:
            ...
            dist = cv2.distanceTransform(self.map, cv2.DIST_L2, 3)
            ...
            for next in neighbors:
                new_cost = cost_so_far[current] + 5/dist[current] + self.distance(current, next)
...
def main():
    ...
    plt.savefig(f'pathfind_map_{map_file[:-4]}_heuristic_{heuristic_weight}.png')
